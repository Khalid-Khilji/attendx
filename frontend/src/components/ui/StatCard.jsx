...
const StatCard = ({ icon: Icon, label, value, color, delay }) => (
    <motion.div
        ...
        className="bg-white dark:bg-zinc-900 rounded-4xl border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm hover:shadow-xl hover:shadow-zinc-500/5 transition-all group"
    >
