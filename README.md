...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/InsightFace-Face_AI-orange?style=for-the-badge" alt="InsightFace" />
  <img src="https://img.shields.io/badge/ONNX_Runtime-1.24.3-005CED?style=for-the-badge&logo=onnx&logoColor=white" alt="ONNX" />
  <img src="https://img.shields.io/badge/Vite-Frontend_Build_Tool-646CFF?style=for-the-badge&logo=vite&logoColor=white" alt="Vite" />
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Status-Completed-success?style=flat-square" alt="Status" />
  <img src="https://img.shields.io/badge/Project-Academic-blue?style=flat-square" alt="Academic Project" />
  <img src="https://img.shields.io/badge/Domain-Machine%20Learning-purple?style=flat-square" alt="Machine Learning" />
  <img src="https://img.shields.io/badge/Domain-Computer%20Vision-red?style=flat-square" alt="Computer Vision" />
</p>
...
```
👨‍🏫 Teacher → 📢 Roll Call → ✍️ Manual Entry → 🗂️ Separate Records → 📊 Manual Analysis
```

**AttendX**

```
📷 Classroom → 👁️ Face Detection → 🧠 Face Recognition → 📐 Identity Matching
   → ✅ Automated Attendance → 🍃 Centralized Database → 📊 Analytics & Reports
```
